...
Adapted on 18/05/2019

@author: Biagio Brattoli
@editor: Abdullah Zaiter
"""
...
#    logger_test = None
    ...
    # Train the Model
    steps = 0
    for epoch in range(args.iter_start,args.epochs):
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            if steps%100==0:
                print ('[{}/{}] {}), Loss: {}, mAP {}'.format(epoch+1, args.epochs, steps, loss,100*np.mean(mAP[-20:])))
...
def test(net,criterion,logger,val_loader,steps):
    ...
    print ('TESTING: {}, mAP {}'.format(steps,100*np.mean(mAP)))
    net.train()
